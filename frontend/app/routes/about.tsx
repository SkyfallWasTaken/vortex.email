	...
	return (
		<div className="flex flex-col md:p-6 mx-6 my-6 prose">
			...
			<p>
				...
				password reset without giving away your private information. This kind
				of <strong>throwaway email</strong> is your best defense against future
				spam.
			</p>
			...
			<p>
				The project is also completely open source. You can check out the code
				on{" "}
				<a
